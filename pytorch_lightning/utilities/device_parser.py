...
from typing import Any, List, MutableSequence, Optional, Union, Set, Tuple
...
def _tpu_cores_valid(tpu_cores: Optional[Union[int, List[int], Tuple[int]]]) -> bool:
    # allow 1 or 8 cores
    if tpu_cores in (1, 8, None):
        return True

    # allow picking 1 of 8 indexes
    if isinstance(tpu_cores, (list, tuple)):
